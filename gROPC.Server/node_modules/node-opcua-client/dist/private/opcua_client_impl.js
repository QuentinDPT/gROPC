...
class OPCUAClientImpl extends client_base_impl_1.ClientBaseImpl {
    constructor(options) {
        ...
        this.endpointMustExist = node_opcua_utils_1.isNullOrUndefined(options.endpointMustExist) ? true : !!options.endpointMustExist;
    ...
    closeSession(...args) {
        ...
        const callback = args[2];
        node_opcua_assert_1.assert(typeof deleteSubscriptions === "boolean");
        node_opcua_assert_1.assert(typeof callback === "function");
    ...
    withSession(connectionPoint, inner_func, ...args) {
        ...
        node_opcua_assert_1.assert(typeof inner_func === "function", "expecting inner function");
        node_opcua_assert_1.assert(typeof callback === "function", "expecting callback function");
        let theSession;
        let the_error;
    ...
    withSubscription(endpointUrl, subscriptionParameters, innerFunc, callback) {
        node_opcua_assert_1.assert(typeof innerFunc === "function");
        node_opcua_assert_1.assert(typeof callback === "function");
    ...
    reactivateSession(session, callback) {
        ...
        node_opcua_assert_1.assert(!internalSession._client || node_opcua_utils_1.matchUri(internalSession._client.endpointUrl, this.endpointUrl), "cannot reactivateSession on a different endpoint");
            ...
            if (!err) {
                if (old_client !== this) {
                    ...
                    if (old_client) {
                        ...
                        node_opcua_assert_1.assert(old_client._sessions.indexOf(internalSession) === -1);
                    }
                    ...
                    node_opcua_assert_1.assert(this._sessions.indexOf(internalSession) !== -1);
                }
                callback();
            }
            else {
    ...
    __createSession_step3(session, callback) {
        ...
        node_opcua_assert_1.assert(this.serverUri !== undefined, " must have a valid server URI " + this.serverUri);
