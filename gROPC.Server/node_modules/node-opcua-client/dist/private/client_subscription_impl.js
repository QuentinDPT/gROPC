...
function createMonitoredItemsAndRespectOperationalLimits(session, createMonitorItemsRequest, callback) {
    node_opcua_pseudo_session_1.readOperationLimits(session).then((operationalLimits) => {
        node_opcua_pseudo_session_1.createMonitoredItemsLimit(operationalLimits.maxMonitoredItemsPerCall || 0, session, createMonitorItemsRequest)
