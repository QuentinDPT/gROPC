...
function _adjust_maxNotificationsPerPublish(maxNotificationsPerPublish) {
    node_opcua_assert_1.assert(Subscription.maxNotificationPerPublishHighLimit > 0, "Subscription.maxNotificationPerPublishHighLimit must be positive");
    ...
    node_opcua_assert_1.assert(maxNotificationsPerPublish !== 0 && maxNotificationsPerPublish <= Subscription.maxNotificationPerPublishHighLimit);
...
function analyseDataChangeFilterResult(node, dataChangeFilter) {
    node_opcua_assert_1.assert(dataChangeFilter instanceof node_opcua_service_subscription_2.DataChangeFilter);
...
class Subscription extends events_1.EventEmitter {
    ...
    preCreateMonitoredItem(addressSpace, timestampsToReturn, monitoredItemCreateRequest) {
        node_opcua_assert_1.assert(monitoredItemCreateRequest instanceof node_opcua_service_subscription_2.MonitoredItemCreateRequest);
        ...
        // check dataEncoding
        if (!node_opcua_data_model_1.isValidDataEncoding(itemToMonitor.dataEncoding)) {
...
Subscription.maxNotificationPerPublishHighLimit = 5000;
